...
<div class="row mt-2 mb-2">
    <div class="col-12 mt-4 mb-4">
        <h1 class="menu"> Mes commandes en cours </h1>
    </div>
</div>
...
<div class="row mt-2 mb-5">
    ...
    $requete = $bdd -> prepare('SELECT * FROM utilisateur NATURAL JOIN commande  WHERE id_utilisateur = :id AND date_commande < :date ');
